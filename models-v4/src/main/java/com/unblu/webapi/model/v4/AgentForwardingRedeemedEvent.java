...
@JsonPropertyOrder({
	...
	AgentForwardingRedeemedEvent.JSON_PROPERTY_RESERVATION,
...
public class AgentForwardingRedeemedEvent {
	...
	public AgentForwardingRedeemedEvent reservation(InvitationReservationData reservation) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, agentForwardingRedeemedEvent.$type) &&
				...
				Objects.equals(this.reservation, agentForwardingRedeemedEvent.reservation) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, timestamp, eventType, accountId, invitationId, conversation, token, creationTimestamp, creatorType, creatorPerson, reservation, contextPersonInfo, target, comment, redeemingPerson);
	}
