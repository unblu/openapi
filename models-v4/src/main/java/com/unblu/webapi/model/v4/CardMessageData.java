...
@JsonPropertyOrder({
	...
	CardMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	CardMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
...
public class CardMessageData implements MessageData {
	...
	public CardMessageData externalMessageId(String externalMessageId) {
	...
	public CardMessageData replyToExternalMessageId(String replyToExternalMessageId) {
	...
	public CardMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public CardMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public CardMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, cardMessageData.$type) &&
				...
				Objects.equals(this.lastEditedByPersonId, cardMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, cardMessageData.lastEditedTimestamp) &&
