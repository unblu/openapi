...
/**
 * An event triggered every time an agent person&#39;s state changes &lt;p&gt; Supported filter keys: &lt;ul&gt;
 * &lt;li&gt;&#x60;ETypedEventFilterKey.PERSON_ID&#x60;: person ID&lt;/li&gt; &lt;/ul&gt;
 */
@ApiModel(description = "An event triggered every time an agent person's state changes <p> Supported filter keys: <ul> <li>`ETypedEventFilterKey.PERSON_ID`: person ID</li> </ul>")
