...
@JsonPropertyOrder({
	...
	SystemMessageData.JSON_PROPERTY_LOCALE,
	SystemMessageData.JSON_PROPERTY_CONVERSATION_LOCALE,
	SystemMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	SystemMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
...
public class SystemMessageData implements MessageData {
	...
	public SystemMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public SystemMessageData conversationLocale(String conversationLocale) {
	...
	public SystemMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public SystemMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, systemMessageData.$type) &&
				...
				Objects.equals(this.locale, systemMessageData.locale) &&
				Objects.equals(this.conversationLocale, systemMessageData.conversationLocale) &&
				Objects.equals(this.lastEditedByPersonId, systemMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, systemMessageData.lastEditedTimestamp) &&
