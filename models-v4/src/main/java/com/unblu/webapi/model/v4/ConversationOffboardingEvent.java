...
/**
 * An event triggered every time a conversation&#39;s state is set to OFFBOARDING &lt;p&gt; Supported filter keys: &lt;ul&gt;
 ...
 */
@ApiModel(description = "An event triggered every time a conversation's state is set to OFFBOARDING <p> Supported filter keys: <ul> <li>`ETypedEventFilterKey.CONVERSATION_ID`: conversation ID</li> <li>`ETypedEventFilterKey.PARTICIPANT_PERSON_ID`: participant person ID</li> </ul>")
