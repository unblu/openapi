...
/**
 * Container to return list of apikeys
 */
@ApiModel(description = "Container to return list of apikeys")

@JsonPropertyOrder({
	ApiKeyResult.JSON_PROPERTY_$_TYPE,
	ApiKeyResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	ApiKeyResult.JSON_PROPERTY_NEXT_OFFSET,
	ApiKeyResult.JSON_PROPERTY_ITEMS,
})
...
public class ApiKeyResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.APIKEYRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.APIKEYRESULT;
	...
	public ApiKeyResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public ApiKeyResult hasMoreItems(Boolean hasMoreItems) {
	...
	public ApiKeyResult nextOffset(Integer nextOffset) {
	...
	public ApiKeyResult items(List<ApiKey> items) {
		this.items = items;
		return this;
	}

	public ApiKeyResult addItemsItem(ApiKey itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ApiKeyResult apiKeyResult = (ApiKeyResult) o;
		return Objects.equals(this.$type, apiKeyResult.$type) &&
				Objects.equals(this.hasMoreItems, apiKeyResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, apiKeyResult.nextOffset) &&
				Objects.equals(this.items, apiKeyResult.items);
	}
