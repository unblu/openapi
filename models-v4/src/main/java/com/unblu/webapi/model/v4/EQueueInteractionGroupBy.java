...
/**
 * Gets or Sets EQueueInteractionGroupBy
 */
public enum EQueueInteractionGroupBy {
	...
	EQueueInteractionGroupBy(String value) {
		this.value = value;
	}
	...
	@JsonCreator
	public static EQueueInteractionGroupBy fromValue(String value) {
		for (EQueueInteractionGroupBy b : EQueueInteractionGroupBy.values()) {
