...
public class RecordRetentionData {
	...
	public static final String JSON_PROPERTY_RETENTION_INTERVAL_WEBHOOK_DELIVERY_LOG_SECONDS = "retentionIntervalWebhookDeliveryLogSeconds";
	@JsonProperty(JSON_PROPERTY_RETENTION_INTERVAL_WEBHOOK_DELIVERY_LOG_SECONDS)
	private Long retentionIntervalWebhookDeliveryLogSeconds;
	...
	public RecordRetentionData retentionIntervalWebhookDeliveryLogSeconds(Long retentionIntervalWebhookDeliveryLogSeconds) {
		this.retentionIntervalWebhookDeliveryLogSeconds = retentionIntervalWebhookDeliveryLogSeconds;
		return this;
	}

	/**
	 * Retention interval of webhook delivery logs represented as number of seconds. Webhook logs are deleted after the time set below, counting from when they were
	 * created.
	 * 
	 * @return retentionIntervalWebhookDeliveryLogSeconds
	 **/
	@ApiModelProperty(value = "Retention interval of webhook delivery logs represented as number of seconds. Webhook logs are deleted after the time set below, counting from when they were created.")
	public Long getRetentionIntervalWebhookDeliveryLogSeconds() {
		return retentionIntervalWebhookDeliveryLogSeconds;
	}

	public void setRetentionIntervalWebhookDeliveryLogSeconds(Long retentionIntervalWebhookDeliveryLogSeconds) {
		this.retentionIntervalWebhookDeliveryLogSeconds = retentionIntervalWebhookDeliveryLogSeconds;
	}
