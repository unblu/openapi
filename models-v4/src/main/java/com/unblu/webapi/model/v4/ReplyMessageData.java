...
@JsonPropertyOrder({
	...
	ReplyMessageData.JSON_PROPERTY_REPLY_TO_MESSAGE_ID,
	ReplyMessageData.JSON_PROPERTY_EXTERNAL_MESSAGE_ID,
	ReplyMessageData.JSON_PROPERTY_REPLY_TO_EXTERNAL_MESSAGE_ID,
	ReplyMessageData.JSON_PROPERTY_LOCALE,
	ReplyMessageData.JSON_PROPERTY_CONVERSATION_LOCALE,
	ReplyMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	ReplyMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
...
public class ReplyMessageData implements MessageData {
	...
	public ReplyMessageData replyToMessageId(String replyToMessageId) {
	...
	public ReplyMessageData externalMessageId(String externalMessageId) {
	...
	public ReplyMessageData replyToExternalMessageId(String replyToExternalMessageId) {
	...
	public ReplyMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public ReplyMessageData conversationLocale(String conversationLocale) {
	...
	public ReplyMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public ReplyMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, replyMessageData.$type) &&
				...
				Objects.equals(this.replyToMessageId, replyMessageData.replyToMessageId) &&
				Objects.equals(this.externalMessageId, replyMessageData.externalMessageId) &&
				Objects.equals(this.replyToExternalMessageId, replyMessageData.replyToExternalMessageId) &&
				...
				Objects.equals(this.lastEditedByPersonId, replyMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, replyMessageData.lastEditedTimestamp) &&
