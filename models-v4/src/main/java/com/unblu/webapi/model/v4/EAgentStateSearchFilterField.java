...
/**
 * Gets or Sets EAgentStateSearchFilterField
 */
public enum EAgentStateSearchFilterField {
	...
	EAgentStateSearchFilterField(String value) {
		this.value = value;
	}
	...
	@JsonCreator
	public static EAgentStateSearchFilterField fromValue(String value) {
		for (EAgentStateSearchFilterField b : EAgentStateSearchFilterField.values()) {
