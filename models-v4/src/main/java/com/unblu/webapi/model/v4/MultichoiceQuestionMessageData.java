...
@JsonPropertyOrder({
	...
	MultichoiceQuestionMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	MultichoiceQuestionMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
	...
	MultichoiceQuestionMessageData.JSON_PROPERTY_AVAILABLE_TRANSLATIONS,
})
...
public class MultichoiceQuestionMessageData implements MessageData {
	...
	public MultichoiceQuestionMessageData externalMessageId(String externalMessageId) {
	...
	public MultichoiceQuestionMessageData replyToExternalMessageId(String replyToExternalMessageId) {
	...
	public MultichoiceQuestionMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public MultichoiceQuestionMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public MultichoiceQuestionMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public MultichoiceQuestionMessageData availableTranslations(List<MultichoiceQuestionMessageTranslation> availableTranslations) {
		this.availableTranslations = availableTranslations;
		return this;
	}

	public MultichoiceQuestionMessageData addAvailableTranslationsItem(MultichoiceQuestionMessageTranslation availableTranslationsItem) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, multichoiceQuestionMessageData.$type) &&
				...
				Objects.equals(this.lastEditedByPersonId, multichoiceQuestionMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, multichoiceQuestionMessageData.lastEditedTimestamp) &&
				...
				Objects.equals(this.availableTranslations, multichoiceQuestionMessageData.availableTranslations);
	}
