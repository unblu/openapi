...
@JsonPropertyOrder({
	...
	PersonVisibilityRuleData.JSON_PROPERTY_SHOW_VISITOR_CONVERSATIONS,
...
public class PersonVisibilityRuleData {
	...
	private EVisibilityLabelSelection agentLabelSelection;
	...
	private EVisibilityLabelSelection visitorLabelSelection;
	...
	public static final String JSON_PROPERTY_SHOW_VISITOR_CONVERSATIONS = "showVisitorConversations";
	@JsonProperty(JSON_PROPERTY_SHOW_VISITOR_CONVERSATIONS)
	private Boolean showVisitorConversations;
	...
	/**
	 * The rule&#39;s unique ID. When creating a rule this property can be omitted, it&#39;s generated by the server.
	 * 
	 * @return id
	 **/
	@ApiModelProperty(value = "The rule's unique ID. When creating a rule this property can be omitted, it's generated by the server.")
	public String getId() {
		return id;
	}
	...
	/**
	 * Description of the visibility rule. Maximum length of 2000 characters. Optional.
	 * 
	 * @return description
	 **/
	@ApiModelProperty(value = "Description of the visibility rule. Maximum length of 2000 characters. Optional.")
	...
	public PersonVisibilityRuleData agentLabelSelection(EVisibilityLabelSelection agentLabelSelection) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public EVisibilityLabelSelection getAgentLabelSelection() {
		return agentLabelSelection;
	}

	public void setAgentLabelSelection(EVisibilityLabelSelection agentLabelSelection) {
		this.agentLabelSelection = agentLabelSelection;
	}
	...
	/**
	 * A list of all the person labels an agent needs to have so that they&#39;re selected by the visibility rule. May contain at most one label per scope.
	 * Mandatory when agentLabelSelection &#x3D; DEFINED_LABELS.
	 * 
	 * @return agentLabelNames
	 **/
	@ApiModelProperty(value = "A list of all the person labels an agent needs to have so that they're selected by the visibility rule. May contain at most one label per scope. Mandatory when agentLabelSelection = DEFINED_LABELS.")
	...
	public PersonVisibilityRuleData visitorLabelSelection(EVisibilityLabelSelection visitorLabelSelection) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public EVisibilityLabelSelection getVisitorLabelSelection() {
		return visitorLabelSelection;
	}

	public void setVisitorLabelSelection(EVisibilityLabelSelection visitorLabelSelection) {
		this.visitorLabelSelection = visitorLabelSelection;
	}
	...
	/**
	 * A list of all the person labels a visitor needs to have so that they&#39;re selected by the visibility rule. May contain at most one label per scope.
	 * Mandatory when visitorLabelSelection &#x3D; DEFINED_LABELS.
	 * 
	 * @return visitorLabelNames
	 **/
	@ApiModelProperty(value = "A list of all the person labels a visitor needs to have so that they're selected by the visibility rule. May contain at most one label per scope. Mandatory when visitorLabelSelection = DEFINED_LABELS.")
	...
	public PersonVisibilityRuleData showVisitorConversations(Boolean showVisitorConversations) {
		this.showVisitorConversations = showVisitorConversations;
		return this;
	}

	/**
	 * When true, an agent matched by this rule additionally sees the conversations of the context persons the rule grants visibility of. Evaluated against the
	 * context person&#39;s labels only, not the conversation&#39;s own labels. The default value is true, so a rule keeps exposing those persons&#39; conversations
	 * unless this is explicitly disabled.
	 * 
	 * @return showVisitorConversations
	 **/
	@ApiModelProperty(value = "When true, an agent matched by this rule additionally sees the conversations of the context persons the rule grants visibility of. Evaluated against the context person's labels only, not the conversation's own labels. The default value is true, so a rule keeps exposing those persons' conversations unless this is explicitly disabled.")
	public Boolean isShowVisitorConversations() {
		return showVisitorConversations;
	}

	public void setShowVisitorConversations(Boolean showVisitorConversations) {
		this.showVisitorConversations = showVisitorConversations;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, personVisibilityRuleData.$type) &&
				...
				Objects.equals(this.showVisitorConversations, personVisibilityRuleData.showVisitorConversations) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, id, accountId, name, enabled, description, agentLabelSelection, agentLabelNames, visitorLabelSelection, visitorLabelNames, showVisitorConversations, creationTimestamp, modificationTimestamp, version);
	}
	...
	public String toString() {
		...
		sb.append("    showVisitorConversations: ").append(toIndentedString(showVisitorConversations)).append("\n");
