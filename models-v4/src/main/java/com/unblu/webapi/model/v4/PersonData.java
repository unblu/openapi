...
@JsonPropertyOrder({
	...
	PersonData.JSON_PROPERTY_FUNCTION_TITLE,
	...
	PersonData.JSON_PROPERTY_LABELS,
...
public class PersonData implements ConversationRecipientData, AgentTargetData {
	...
	public PersonData functionTitle(String functionTitle) {
	...
	public PersonData note(String note) {
		this.note = note;
		return this;
	}
	...
	public PersonData noteLastEditedTimestamp(Long noteLastEditedTimestamp) {
	...
	public PersonData noteLastEditedPersonId(String noteLastEditedPersonId) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, personData.$type) &&
				...
				Objects.equals(this.functionTitle, personData.functionTitle) &&
				...
				Objects.equals(this.labels, personData.labels) &&
