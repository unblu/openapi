...
/**
 * An event triggered every time a conversation&#39;s state changes from ONBOARDING to QUEUED &lt;p&gt; Supported filter keys: &lt;ul&gt;
 ...
 */
@ApiModel(description = "An event triggered every time a conversation's state changes from ONBOARDING to QUEUED <p> Supported filter keys: <ul> <li>`ETypedEventFilterKey.CONVERSATION_ID`: conversation ID</li> <li>`ETypedEventFilterKey.PARTICIPANT_PERSON_ID`: participant person ID</li> </ul>")
