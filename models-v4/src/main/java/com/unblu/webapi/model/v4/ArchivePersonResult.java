...
public class ArchivePersonResult {
	...
	/**
	 * @code{ true} if this call archived the person; @code{ false} if the person was already archived (idempotent re-archive).
	 * 
	 * @return newlyArchived
	 **/
	@ApiModelProperty(value = "@code{ true} if this call archived the person; @code{ false} if the person was already archived (idempotent re-archive).")
