...
@JsonPropertyOrder({
	CustomDialogBotData.JSON_PROPERTY_$_TYPE,
	CustomDialogBotData.JSON_PROPERTY_ID,
	CustomDialogBotData.JSON_PROPERTY_CREATION_TIMESTAMP,
	CustomDialogBotData.JSON_PROPERTY_MODIFICATION_TIMESTAMP,
	CustomDialogBotData.JSON_PROPERTY_VERSION,
	CustomDialogBotData.JSON_PROPERTY_ACCOUNT_ID,
	CustomDialogBotData.JSON_PROPERTY_NAME,
	CustomDialogBotData.JSON_PROPERTY_DESCRIPTION,
	CustomDialogBotData.JSON_PROPERTY_BOT_PERSON_ID,
	CustomDialogBotData.JSON_PROPERTY_ONBOARDING_ORDER,
	CustomDialogBotData.JSON_PROPERTY_REBOARDING_ORDER,
	CustomDialogBotData.JSON_PROPERTY_OFFBOARDING_ORDER,
	CustomDialogBotData.JSON_PROPERTY_ONBOARDING_FILTER,
	CustomDialogBotData.JSON_PROPERTY_REBOARDING_ENABLED,
	...
	CustomDialogBotData.JSON_PROPERTY_BOT_INDICATOR_TYPE,
	CustomDialogBotData.JSON_PROPERTY_THINKING_TEXTS,
	CustomDialogBotData.JSON_PROPERTY_THINKING_INPUT_MODE,
	CustomDialogBotData.JSON_PROPERTY_RANDOMIZE_THINKING_TEXTS,
	CustomDialogBotData.JSON_PROPERTY_MAX_THINKING_INDICATOR_TIME,
	CustomDialogBotData.JSON_PROPERTY_AUTO_START_THINKING_INDICATOR_DELAY,
	CustomDialogBotData.JSON_PROPERTY_THINKING_INDICATOR_TEXT_CYCLE_INTERVAL,
	CustomDialogBotData.JSON_PROPERTY_WEBHOOK_STATUS,
	CustomDialogBotData.JSON_PROPERTY_WEBHOOK_ENDPOINT,
	CustomDialogBotData.JSON_PROPERTY_OUTBOUND_TIMEOUT_MILLIS,
	CustomDialogBotData.JSON_PROPERTY_WEBHOOK_API_VERSION,
...
public class CustomDialogBotData implements DialogBotData {
	...
	public enum TypeEnum {
		CUSTOMDIALOGBOTDATA("CustomDialogBotData");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.CUSTOMDIALOGBOTDATA;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.CUSTOMDIALOGBOTDATA;
	...
	private EBotType type = EBotType.CUSTOM;
	...
	public CustomDialogBotData id(String id) {
		this.id = id;
		return this;
	}
	...
	public CustomDialogBotData creationTimestamp(Long creationTimestamp) {
	...
	public CustomDialogBotData modificationTimestamp(Long modificationTimestamp) {
	...
	public CustomDialogBotData version(Long version) {
	...
	public CustomDialogBotData accountId(String accountId) {
	...
	public CustomDialogBotData name(String name) {
		this.name = name;
		return this;
	}
	...
	public CustomDialogBotData description(String description) {
	...
	public CustomDialogBotData botPersonId(String botPersonId) {
	...
	public CustomDialogBotData onboardingOrder(Integer onboardingOrder) {
	...
	public CustomDialogBotData reboardingOrder(Integer reboardingOrder) {
	...
	public CustomDialogBotData offboardingOrder(Integer offboardingOrder) {
	...
	public CustomDialogBotData onboardingFilter(EBotDialogFilter onboardingFilter) {
	...
	public CustomDialogBotData reboardingEnabled(Boolean reboardingEnabled) {
	...
	public CustomDialogBotData offboardingFilter(EBotDialogFilter offboardingFilter) {
	...
	public CustomDialogBotData needsCounterpartPresence(Boolean needsCounterpartPresence) {
	...
	public CustomDialogBotData onTimeoutBehavior(EBotDialogTimeoutBehavior onTimeoutBehavior) {
	...
	public CustomDialogBotData botIndicatorType(EBotIndicatorType botIndicatorType) {
	...
	public CustomDialogBotData thinkingTexts(List<BotThinkingTextData> thinkingTexts) {
		this.thinkingTexts = thinkingTexts;
		return this;
	}

	public CustomDialogBotData addThinkingTextsItem(BotThinkingTextData thinkingTextsItem) {
	...
	public CustomDialogBotData thinkingInputMode(EThinkingInputMode thinkingInputMode) {
	...
	public CustomDialogBotData randomizeThinkingTexts(Boolean randomizeThinkingTexts) {
	...
	public CustomDialogBotData maxThinkingIndicatorTime(Integer maxThinkingIndicatorTime) {
	...
	public CustomDialogBotData autoStartThinkingIndicatorDelay(Integer autoStartThinkingIndicatorDelay) {
	...
	public CustomDialogBotData thinkingIndicatorTextCycleInterval(Integer thinkingIndicatorTextCycleInterval) {
	...
	public CustomDialogBotData webhookStatus(ERegistrationStatus webhookStatus) {
	...
	public CustomDialogBotData webhookEndpoint(String webhookEndpoint) {
	...
	public CustomDialogBotData outboundTimeoutMillis(Long outboundTimeoutMillis) {
	...
	public CustomDialogBotData webhookApiVersion(EWebApiVersion webhookApiVersion) {
	...
	public CustomDialogBotData webhookSecret(String webhookSecret) {
	...
	public CustomDialogBotData messageStateHandledExternally(Boolean messageStateHandledExternally) {
	...
	public CustomDialogBotData automaticTypingStateHandlingEnabled(Boolean automaticTypingStateHandlingEnabled) {
	...
	public boolean equals(java.lang.Object o) {
		...
		CustomDialogBotData customDialogBotData = (CustomDialogBotData) o;
		return Objects.equals(this.$type, customDialogBotData.$type) &&
				Objects.equals(this.id, customDialogBotData.id) &&
				Objects.equals(this.creationTimestamp, customDialogBotData.creationTimestamp) &&
				Objects.equals(this.modificationTimestamp, customDialogBotData.modificationTimestamp) &&
				Objects.equals(this.version, customDialogBotData.version) &&
				Objects.equals(this.accountId, customDialogBotData.accountId) &&
				Objects.equals(this.name, customDialogBotData.name) &&
				Objects.equals(this.description, customDialogBotData.description) &&
				Objects.equals(this.botPersonId, customDialogBotData.botPersonId) &&
				Objects.equals(this.onboardingOrder, customDialogBotData.onboardingOrder) &&
				Objects.equals(this.reboardingOrder, customDialogBotData.reboardingOrder) &&
				Objects.equals(this.offboardingOrder, customDialogBotData.offboardingOrder) &&
				Objects.equals(this.onboardingFilter, customDialogBotData.onboardingFilter) &&
				Objects.equals(this.reboardingEnabled, customDialogBotData.reboardingEnabled) &&
				...
				Objects.equals(this.botIndicatorType, customDialogBotData.botIndicatorType) &&
				Objects.equals(this.thinkingTexts, customDialogBotData.thinkingTexts) &&
				Objects.equals(this.thinkingInputMode, customDialogBotData.thinkingInputMode) &&
				Objects.equals(this.randomizeThinkingTexts, customDialogBotData.randomizeThinkingTexts) &&
				Objects.equals(this.maxThinkingIndicatorTime, customDialogBotData.maxThinkingIndicatorTime) &&
				Objects.equals(this.autoStartThinkingIndicatorDelay, customDialogBotData.autoStartThinkingIndicatorDelay) &&
				Objects.equals(this.thinkingIndicatorTextCycleInterval, customDialogBotData.thinkingIndicatorTextCycleInterval) &&
				...
				Objects.equals(this.outboundTimeoutMillis, customDialogBotData.outboundTimeoutMillis) &&
	...
	public String toString() {
		...
		sb.append("class CustomDialogBotData {\n");
