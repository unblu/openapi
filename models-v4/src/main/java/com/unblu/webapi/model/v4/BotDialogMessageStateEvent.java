...
/**
 * Event emitted when a message in a dialog between a person and a bot is marked as delivered/read. &lt;p&gt; The event is only delivered to the dialog bots
 * that accepted the dialog offer for the dialog.
 */
@ApiModel(description = "Event emitted when a message in a dialog between a person and a bot is marked as delivered/read. <p> The event is only delivered to the dialog bots that accepted the dialog offer for the dialog.")
