...
/**
 * An event triggered every time the awaited person type of a conversation changes &lt;p&gt; Supported filter keys: &lt;ul&gt;
 ...
 */
@ApiModel(description = "An event triggered every time the awaited person type of a conversation changes <p> Supported filter keys: <ul> <li>`ETypedEventFilterKey.CONVERSATION_ID`: conversation ID</li> <li>`ETypedEventFilterKey.PARTICIPANT_PERSON_ID`: participant person ID</li> </ul>")
