...
public class MessagesCountAnalyticsWidgetData implements AnalyticsWidgetData {
	...
	/**
	 * Specifies how results are grouped for the number of messages KPI.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the number of messages KPI.")
