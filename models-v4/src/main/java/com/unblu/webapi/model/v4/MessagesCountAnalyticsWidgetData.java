...
/**
 * Data model representing the number of messages analytics widget
 */
@ApiModel(description = "Data model representing the number of messages analytics widget")

@JsonPropertyOrder({
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_$_TYPE,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_ID,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_ACCOUNT_ID,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_CREATION_TIMESTAMP,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_MODIFICATION_TIMESTAMP,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_VERSION,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_ANALYTICS_DASHBOARD_ID,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_NAME,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_DESCRIPTION,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_KPI_TYPE,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_ROW,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_ROW_SPAN,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN_SPAN,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_AGGREGATION,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_PREVIOUS_PERIOD_COMPARISON,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_CHART,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_TYPE,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_SPAN,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_LAST_DAYS,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_GRANULARITY_TYPE,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_FIXED_GRANULARITY,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_TRANSLATIONS,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_REFERENCE_LINES,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS_TYPE,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_GROUP_BY,
	MessagesCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS,
})
@JsonAutoDetect(creatorVisibility = Visibility.NONE, fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE, setterVisibility = Visibility.NONE)
public class MessagesCountAnalyticsWidgetData implements AnalyticsWidgetData {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		MESSAGESCOUNTANALYTICSWIDGETDATA("MessagesCountAnalyticsWidgetData");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.MESSAGESCOUNTANALYTICSWIDGETDATA;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.MESSAGESCOUNTANALYTICSWIDGETDATA;
	...
	private EAnalyticsKpiType kpiType = EAnalyticsKpiType.MESSAGES_COUNT;
	...
	private List<EMessagesCountGroupBy> groupBy = null;

	public static final String JSON_PROPERTY_FILTERS = "filters";
	@JsonProperty(JSON_PROPERTY_FILTERS)
	private MessagesCountAnalyticsKpiFilterData filters = null;

	public MessagesCountAnalyticsWidgetData $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public MessagesCountAnalyticsWidgetData id(String id) {
		this.id = id;
		return this;
	}
	...
	public MessagesCountAnalyticsWidgetData accountId(String accountId) {
	...
	public MessagesCountAnalyticsWidgetData creationTimestamp(Long creationTimestamp) {
	...
	public MessagesCountAnalyticsWidgetData modificationTimestamp(Long modificationTimestamp) {
	...
	public MessagesCountAnalyticsWidgetData version(Long version) {
	...
	public MessagesCountAnalyticsWidgetData analyticsDashboardId(String analyticsDashboardId) {
	...
	public MessagesCountAnalyticsWidgetData name(String name) {
		this.name = name;
		return this;
	}
	...
	public MessagesCountAnalyticsWidgetData description(String description) {
	...
	public MessagesCountAnalyticsWidgetData kpiType(EAnalyticsKpiType kpiType) {
	...
	public MessagesCountAnalyticsWidgetData row(Integer row) {
		this.row = row;
		return this;
	}
	...
	public MessagesCountAnalyticsWidgetData rowSpan(Integer rowSpan) {
	...
	public MessagesCountAnalyticsWidgetData column(Integer column) {
		this.column = column;
		return this;
	}
	...
	public MessagesCountAnalyticsWidgetData columnSpan(Integer columnSpan) {
	...
	public MessagesCountAnalyticsWidgetData displaySingleValueAggregation(EAnalyticsKpiDisplaySingleValueAggregation displaySingleValueAggregation) {
	...
	public MessagesCountAnalyticsWidgetData displaySingleValuePreviousPeriodComparison(Boolean displaySingleValuePreviousPeriodComparison) {
	...
	public MessagesCountAnalyticsWidgetData displayChart(EAnalyticsKpiDisplayChart displayChart) {
	...
	public MessagesCountAnalyticsWidgetData initialTimeFrameType(EAnalyticsKpiTimeFrameType initialTimeFrameType) {
	...
	public MessagesCountAnalyticsWidgetData initialTimeFrameSpan(EAnalyticsKpiFixedTimeFrameSpan initialTimeFrameSpan) {
	...
	public MessagesCountAnalyticsWidgetData initialTimeFrameLastDays(Integer initialTimeFrameLastDays) {
	...
	public MessagesCountAnalyticsWidgetData granularityType(EAnalyticsKpiGranularityType granularityType) {
	...
	public MessagesCountAnalyticsWidgetData fixedGranularity(EAnalyticsKpiFixedGranularity fixedGranularity) {
	...
	public MessagesCountAnalyticsWidgetData translations(Map<String, AnalyticsWidgetTranslation> translations) {
		this.translations = translations;
		return this;
	}

	public MessagesCountAnalyticsWidgetData putTranslationsItem(String key, AnalyticsWidgetTranslation translationsItem) {
	...
	public MessagesCountAnalyticsWidgetData referenceLines(List<AnalyticsKpiReferenceLine> referenceLines) {
		this.referenceLines = referenceLines;
		return this;
	}

	public MessagesCountAnalyticsWidgetData addReferenceLinesItem(AnalyticsKpiReferenceLine referenceLinesItem) {
	...
	public MessagesCountAnalyticsWidgetData filtersType(EAnalyticsKpiFiltersType filtersType) {
	...
	public MessagesCountAnalyticsWidgetData groupBy(List<EMessagesCountGroupBy> groupBy) {
		this.groupBy = groupBy;
		return this;
	}

	public MessagesCountAnalyticsWidgetData addGroupByItem(EMessagesCountGroupBy groupByItem) {
	...
	/**
	 * Specifies how results are grouped for the number of messages KPI. Only the first value of the list is used.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the number of messages KPI. Only the first value of the list is used.")
	public List<EMessagesCountGroupBy> getGroupBy() {
		return groupBy;
	}

	public void setGroupBy(List<EMessagesCountGroupBy> groupBy) {
		this.groupBy = groupBy;
	}

	public MessagesCountAnalyticsWidgetData filters(MessagesCountAnalyticsKpiFilterData filters) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public MessagesCountAnalyticsKpiFilterData getFilters() {
		return filters;
	}

	public void setFilters(MessagesCountAnalyticsKpiFilterData filters) {
		this.filters = filters;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		MessagesCountAnalyticsWidgetData messagesCountAnalyticsWidgetData = (MessagesCountAnalyticsWidgetData) o;
		return Objects.equals(this.$type, messagesCountAnalyticsWidgetData.$type) &&
				Objects.equals(this.id, messagesCountAnalyticsWidgetData.id) &&
				Objects.equals(this.accountId, messagesCountAnalyticsWidgetData.accountId) &&
				Objects.equals(this.creationTimestamp, messagesCountAnalyticsWidgetData.creationTimestamp) &&
				Objects.equals(this.modificationTimestamp, messagesCountAnalyticsWidgetData.modificationTimestamp) &&
				Objects.equals(this.version, messagesCountAnalyticsWidgetData.version) &&
				Objects.equals(this.analyticsDashboardId, messagesCountAnalyticsWidgetData.analyticsDashboardId) &&
				Objects.equals(this.name, messagesCountAnalyticsWidgetData.name) &&
				Objects.equals(this.description, messagesCountAnalyticsWidgetData.description) &&
				Objects.equals(this.kpiType, messagesCountAnalyticsWidgetData.kpiType) &&
				Objects.equals(this.row, messagesCountAnalyticsWidgetData.row) &&
				Objects.equals(this.rowSpan, messagesCountAnalyticsWidgetData.rowSpan) &&
				Objects.equals(this.column, messagesCountAnalyticsWidgetData.column) &&
				Objects.equals(this.columnSpan, messagesCountAnalyticsWidgetData.columnSpan) &&
				Objects.equals(this.displaySingleValueAggregation, messagesCountAnalyticsWidgetData.displaySingleValueAggregation) &&
				Objects.equals(this.displaySingleValuePreviousPeriodComparison, messagesCountAnalyticsWidgetData.displaySingleValuePreviousPeriodComparison) &&
				Objects.equals(this.displayChart, messagesCountAnalyticsWidgetData.displayChart) &&
				Objects.equals(this.initialTimeFrameType, messagesCountAnalyticsWidgetData.initialTimeFrameType) &&
				Objects.equals(this.initialTimeFrameSpan, messagesCountAnalyticsWidgetData.initialTimeFrameSpan) &&
				Objects.equals(this.initialTimeFrameLastDays, messagesCountAnalyticsWidgetData.initialTimeFrameLastDays) &&
				Objects.equals(this.granularityType, messagesCountAnalyticsWidgetData.granularityType) &&
				Objects.equals(this.fixedGranularity, messagesCountAnalyticsWidgetData.fixedGranularity) &&
				Objects.equals(this.translations, messagesCountAnalyticsWidgetData.translations) &&
				Objects.equals(this.referenceLines, messagesCountAnalyticsWidgetData.referenceLines) &&
				Objects.equals(this.filtersType, messagesCountAnalyticsWidgetData.filtersType) &&
				Objects.equals(this.groupBy, messagesCountAnalyticsWidgetData.groupBy) &&
				Objects.equals(this.filters, messagesCountAnalyticsWidgetData.filters);
	}
	...
	public String toString() {
		...
		sb.append("class MessagesCountAnalyticsWidgetData {\n");
