...
@JsonPropertyOrder({
	...
	FileMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	FileMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
...
public class FileMessageData implements MessageData {
	...
	public FileMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public FileMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public FileMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public FileMessageData downloadLinks(List<DownloadLink> downloadLinks) {
		this.downloadLinks = downloadLinks;
		return this;
	}

	public FileMessageData addDownloadLinksItem(DownloadLink downloadLinksItem) {
	...
	/**
	 * URLs to download the file. Access is only permitted for authenticated users that have access to the referenced conversation. Authentication is possible with
	 * basic authentication or a valid session cookie.&lt;br&gt; If the file is currently being reviewed by one or more file interceptors, calling one of the URLs
	 * returns a 403 code until the file upload has been approved.
	 * 
	 * @return downloadLinks
	 **/
	@ApiModelProperty(value = "URLs to download the file. Access is only permitted for authenticated users that have access to the referenced conversation. Authentication is possible with basic authentication or a valid session cookie.<br> If the file is currently being reviewed by one or more file interceptors, calling one of the URLs returns a 403 code until the file upload has been approved.")
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, fileMessageData.$type) &&
				...
				Objects.equals(this.lastEditedByPersonId, fileMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, fileMessageData.lastEditedTimestamp) &&
