...
public class AvgWaitingTimeAnalyticsWidgetData implements AnalyticsWidgetData {
	...
	/**
	 * Specifies how results are grouped for the average waiting time KPI.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the average waiting time KPI.")
