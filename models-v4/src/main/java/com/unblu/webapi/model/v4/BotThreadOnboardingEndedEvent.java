...
/**
 * An event triggered every time a &#x60;BotThread&#x60; is ended during onboarding
 */
@ApiModel(description = "An event triggered every time a `BotThread` is ended during onboarding")

@JsonPropertyOrder({
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_$_TYPE,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_TIMESTAMP,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_EVENT_TYPE,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_ACCOUNT_ID,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_BOT_THREAD_ID,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_CONVERSATION,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_COUNTERPART_PERSON_ID,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_START_TIMESTAMP,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_PARTICIPATING_DIALOG_BOTS,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_BOT_THREAD_RESOLUTION,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_BOT_THREAD_END_TRIGGER,
	BotThreadOnboardingEndedEvent.JSON_PROPERTY_END_TIMESTAMP,
})
@JsonAutoDetect(creatorVisibility = Visibility.NONE, fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE, setterVisibility = Visibility.NONE)
public class BotThreadOnboardingEndedEvent {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		BOTTHREADONBOARDINGENDEDEVENT("BotThreadOnboardingEndedEvent");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.BOTTHREADONBOARDINGENDEDEVENT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.BOTTHREADONBOARDINGENDEDEVENT;
	...
	public BotThreadOnboardingEndedEvent $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public BotThreadOnboardingEndedEvent timestamp(Long timestamp) {
	...
	public BotThreadOnboardingEndedEvent eventType(String eventType) {
	...
	public BotThreadOnboardingEndedEvent accountId(String accountId) {
	...
	public BotThreadOnboardingEndedEvent botThreadId(String botThreadId) {
	...
	public BotThreadOnboardingEndedEvent conversation(ConversationData conversation) {
	...
	public BotThreadOnboardingEndedEvent counterpartPersonId(String counterpartPersonId) {
	...
	public BotThreadOnboardingEndedEvent startTimestamp(Long startTimestamp) {
	...
	public BotThreadOnboardingEndedEvent participatingDialogBots(List<BotDialogStateData> participatingDialogBots) {
		this.participatingDialogBots = participatingDialogBots;
		return this;
	}

	public BotThreadOnboardingEndedEvent addParticipatingDialogBotsItem(BotDialogStateData participatingDialogBotsItem) {
	...
	public BotThreadOnboardingEndedEvent botThreadResolution(EBotThreadResolution botThreadResolution) {
	...
	public BotThreadOnboardingEndedEvent botThreadEndTrigger(EBotThreadEndTrigger botThreadEndTrigger) {
	...
	public BotThreadOnboardingEndedEvent endTimestamp(Long endTimestamp) {
	...
	public boolean equals(java.lang.Object o) {
		...
		BotThreadOnboardingEndedEvent botThreadOnboardingEndedEvent = (BotThreadOnboardingEndedEvent) o;
		return Objects.equals(this.$type, botThreadOnboardingEndedEvent.$type) &&
				Objects.equals(this.timestamp, botThreadOnboardingEndedEvent.timestamp) &&
				Objects.equals(this.eventType, botThreadOnboardingEndedEvent.eventType) &&
				Objects.equals(this.accountId, botThreadOnboardingEndedEvent.accountId) &&
				Objects.equals(this.botThreadId, botThreadOnboardingEndedEvent.botThreadId) &&
				Objects.equals(this.conversation, botThreadOnboardingEndedEvent.conversation) &&
				Objects.equals(this.counterpartPersonId, botThreadOnboardingEndedEvent.counterpartPersonId) &&
				Objects.equals(this.startTimestamp, botThreadOnboardingEndedEvent.startTimestamp) &&
				Objects.equals(this.participatingDialogBots, botThreadOnboardingEndedEvent.participatingDialogBots) &&
				Objects.equals(this.botThreadResolution, botThreadOnboardingEndedEvent.botThreadResolution) &&
				Objects.equals(this.botThreadEndTrigger, botThreadOnboardingEndedEvent.botThreadEndTrigger) &&
				Objects.equals(this.endTimestamp, botThreadOnboardingEndedEvent.endTimestamp);
	}
	...
	public String toString() {
		...
		sb.append("class BotThreadOnboardingEndedEvent {\n");
