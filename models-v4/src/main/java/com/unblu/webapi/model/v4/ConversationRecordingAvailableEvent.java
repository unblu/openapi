...
@JsonPropertyOrder({
	...
	ConversationRecordingAvailableEvent.JSON_PROPERTY_DOWNLOAD_LINKS,
...
public class ConversationRecordingAvailableEvent {
	...
	public ConversationRecordingAvailableEvent downloadLinks(List<DownloadLink> downloadLinks) {
		this.downloadLinks = downloadLinks;
		return this;
	}

	public ConversationRecordingAvailableEvent addDownloadLinksItem(DownloadLink downloadLinksItem) {
	...
	/**
	 * URLs to download the recording. The URLs are only accessible to authenticated users that have access to the referenced conversation. Authentication is
	 * possible with basic authentication or a valid session cookie.
	 * 
	 * @return downloadLinks
	 **/
	@ApiModelProperty(value = "URLs to download the recording. The URLs are only accessible to authenticated users that have access to the referenced conversation. Authentication is possible with basic authentication or a valid session cookie.")
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, conversationRecordingAvailableEvent.$type) &&
				...
				Objects.equals(this.downloadLinks, conversationRecordingAvailableEvent.downloadLinks) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, timestamp, eventType, accountId, conversationId, blobStoreId, mimeType, totalSize, downloadLinks, recordingStartTimestamp, recordingEndTimestamp, endReason);
	}
