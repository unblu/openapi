...
/**
 * Data model representing the calls analytics widget
 */
@ApiModel(description = "Data model representing the calls analytics widget")

@JsonPropertyOrder({
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_$_TYPE,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_ID,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_ACCOUNT_ID,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_CREATION_TIMESTAMP,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_MODIFICATION_TIMESTAMP,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_VERSION,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_ANALYTICS_DASHBOARD_ID,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_NAME,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_DESCRIPTION,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_KPI_TYPE,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_ROW,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_ROW_SPAN,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN_SPAN,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_AGGREGATION,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_PREVIOUS_PERIOD_COMPARISON,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_CHART,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_TYPE,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_SPAN,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_LAST_DAYS,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_GRANULARITY_TYPE,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_FIXED_GRANULARITY,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_TRANSLATIONS,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_REFERENCE_LINES,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS_TYPE,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_GROUP_BY,
	CallsCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS,
})
@JsonAutoDetect(creatorVisibility = Visibility.NONE, fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE, setterVisibility = Visibility.NONE)
public class CallsCountAnalyticsWidgetData implements AnalyticsWidgetData {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		CALLSCOUNTANALYTICSWIDGETDATA("CallsCountAnalyticsWidgetData");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.CALLSCOUNTANALYTICSWIDGETDATA;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.CALLSCOUNTANALYTICSWIDGETDATA;
	...
	private EAnalyticsKpiType kpiType = EAnalyticsKpiType.CALLS_COUNT;
	...
	private List<ECallsCountGroupBy> groupBy = null;

	public static final String JSON_PROPERTY_FILTERS = "filters";
	@JsonProperty(JSON_PROPERTY_FILTERS)
	private CallsCountAnalyticsKpiFilterData filters = null;

	public CallsCountAnalyticsWidgetData $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public CallsCountAnalyticsWidgetData id(String id) {
		this.id = id;
		return this;
	}
	...
	public CallsCountAnalyticsWidgetData accountId(String accountId) {
	...
	public CallsCountAnalyticsWidgetData creationTimestamp(Long creationTimestamp) {
	...
	public CallsCountAnalyticsWidgetData modificationTimestamp(Long modificationTimestamp) {
	...
	public CallsCountAnalyticsWidgetData version(Long version) {
	...
	public CallsCountAnalyticsWidgetData analyticsDashboardId(String analyticsDashboardId) {
	...
	public CallsCountAnalyticsWidgetData name(String name) {
		this.name = name;
		return this;
	}
	...
	public CallsCountAnalyticsWidgetData description(String description) {
	...
	public CallsCountAnalyticsWidgetData kpiType(EAnalyticsKpiType kpiType) {
	...
	public CallsCountAnalyticsWidgetData row(Integer row) {
		this.row = row;
		return this;
	}
	...
	public CallsCountAnalyticsWidgetData rowSpan(Integer rowSpan) {
	...
	public CallsCountAnalyticsWidgetData column(Integer column) {
		this.column = column;
		return this;
	}
	...
	public CallsCountAnalyticsWidgetData columnSpan(Integer columnSpan) {
	...
	public CallsCountAnalyticsWidgetData displaySingleValueAggregation(EAnalyticsKpiDisplaySingleValueAggregation displaySingleValueAggregation) {
	...
	public CallsCountAnalyticsWidgetData displaySingleValuePreviousPeriodComparison(Boolean displaySingleValuePreviousPeriodComparison) {
	...
	public CallsCountAnalyticsWidgetData displayChart(EAnalyticsKpiDisplayChart displayChart) {
	...
	public CallsCountAnalyticsWidgetData initialTimeFrameType(EAnalyticsKpiTimeFrameType initialTimeFrameType) {
	...
	public CallsCountAnalyticsWidgetData initialTimeFrameSpan(EAnalyticsKpiFixedTimeFrameSpan initialTimeFrameSpan) {
	...
	public CallsCountAnalyticsWidgetData initialTimeFrameLastDays(Integer initialTimeFrameLastDays) {
	...
	public CallsCountAnalyticsWidgetData granularityType(EAnalyticsKpiGranularityType granularityType) {
	...
	public CallsCountAnalyticsWidgetData fixedGranularity(EAnalyticsKpiFixedGranularity fixedGranularity) {
	...
	public CallsCountAnalyticsWidgetData translations(Map<String, AnalyticsWidgetTranslation> translations) {
		this.translations = translations;
		return this;
	}

	public CallsCountAnalyticsWidgetData putTranslationsItem(String key, AnalyticsWidgetTranslation translationsItem) {
	...
	public CallsCountAnalyticsWidgetData referenceLines(List<AnalyticsKpiReferenceLine> referenceLines) {
		this.referenceLines = referenceLines;
		return this;
	}

	public CallsCountAnalyticsWidgetData addReferenceLinesItem(AnalyticsKpiReferenceLine referenceLinesItem) {
	...
	public CallsCountAnalyticsWidgetData filtersType(EAnalyticsKpiFiltersType filtersType) {
	...
	public CallsCountAnalyticsWidgetData groupBy(List<ECallsCountGroupBy> groupBy) {
		this.groupBy = groupBy;
		return this;
	}

	public CallsCountAnalyticsWidgetData addGroupByItem(ECallsCountGroupBy groupByItem) {
	...
	/**
	 * Specifies how results are grouped for the calls KPI. Only the first value of the list is used.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the calls KPI. Only the first value of the list is used.")
	public List<ECallsCountGroupBy> getGroupBy() {
		return groupBy;
	}

	public void setGroupBy(List<ECallsCountGroupBy> groupBy) {
		this.groupBy = groupBy;
	}

	public CallsCountAnalyticsWidgetData filters(CallsCountAnalyticsKpiFilterData filters) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public CallsCountAnalyticsKpiFilterData getFilters() {
		return filters;
	}

	public void setFilters(CallsCountAnalyticsKpiFilterData filters) {
		this.filters = filters;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		CallsCountAnalyticsWidgetData callsCountAnalyticsWidgetData = (CallsCountAnalyticsWidgetData) o;
		return Objects.equals(this.$type, callsCountAnalyticsWidgetData.$type) &&
				Objects.equals(this.id, callsCountAnalyticsWidgetData.id) &&
				Objects.equals(this.accountId, callsCountAnalyticsWidgetData.accountId) &&
				Objects.equals(this.creationTimestamp, callsCountAnalyticsWidgetData.creationTimestamp) &&
				Objects.equals(this.modificationTimestamp, callsCountAnalyticsWidgetData.modificationTimestamp) &&
				Objects.equals(this.version, callsCountAnalyticsWidgetData.version) &&
				Objects.equals(this.analyticsDashboardId, callsCountAnalyticsWidgetData.analyticsDashboardId) &&
				Objects.equals(this.name, callsCountAnalyticsWidgetData.name) &&
				Objects.equals(this.description, callsCountAnalyticsWidgetData.description) &&
				Objects.equals(this.kpiType, callsCountAnalyticsWidgetData.kpiType) &&
				Objects.equals(this.row, callsCountAnalyticsWidgetData.row) &&
				Objects.equals(this.rowSpan, callsCountAnalyticsWidgetData.rowSpan) &&
				Objects.equals(this.column, callsCountAnalyticsWidgetData.column) &&
				Objects.equals(this.columnSpan, callsCountAnalyticsWidgetData.columnSpan) &&
				Objects.equals(this.displaySingleValueAggregation, callsCountAnalyticsWidgetData.displaySingleValueAggregation) &&
				Objects.equals(this.displaySingleValuePreviousPeriodComparison, callsCountAnalyticsWidgetData.displaySingleValuePreviousPeriodComparison) &&
				Objects.equals(this.displayChart, callsCountAnalyticsWidgetData.displayChart) &&
				Objects.equals(this.initialTimeFrameType, callsCountAnalyticsWidgetData.initialTimeFrameType) &&
				Objects.equals(this.initialTimeFrameSpan, callsCountAnalyticsWidgetData.initialTimeFrameSpan) &&
				Objects.equals(this.initialTimeFrameLastDays, callsCountAnalyticsWidgetData.initialTimeFrameLastDays) &&
				Objects.equals(this.granularityType, callsCountAnalyticsWidgetData.granularityType) &&
				Objects.equals(this.fixedGranularity, callsCountAnalyticsWidgetData.fixedGranularity) &&
				Objects.equals(this.translations, callsCountAnalyticsWidgetData.translations) &&
				Objects.equals(this.referenceLines, callsCountAnalyticsWidgetData.referenceLines) &&
				Objects.equals(this.filtersType, callsCountAnalyticsWidgetData.filtersType) &&
				Objects.equals(this.groupBy, callsCountAnalyticsWidgetData.groupBy) &&
				Objects.equals(this.filters, callsCountAnalyticsWidgetData.filters);
	}
	...
	public String toString() {
		...
		sb.append("class CallsCountAnalyticsWidgetData {\n");
