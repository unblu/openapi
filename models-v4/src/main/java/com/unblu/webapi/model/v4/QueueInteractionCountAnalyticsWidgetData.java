...
/**
 * Data model representing the queue interaction analytics widget.
 */
@ApiModel(description = "Data model representing the queue interaction analytics widget.")

@JsonPropertyOrder({
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_$_TYPE,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_ID,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_ACCOUNT_ID,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_CREATION_TIMESTAMP,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_MODIFICATION_TIMESTAMP,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_VERSION,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_ANALYTICS_DASHBOARD_ID,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_NAME,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_DESCRIPTION,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_KPI_TYPE,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_ROW,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_ROW_SPAN,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN_SPAN,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_AGGREGATION,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_PREVIOUS_PERIOD_COMPARISON,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_CHART,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_TYPE,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_SPAN,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_LAST_DAYS,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_GRANULARITY_TYPE,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_FIXED_GRANULARITY,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_TRANSLATIONS,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_REFERENCE_LINES,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS_TYPE,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_GROUP_BY,
	QueueInteractionCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS,
})
@JsonAutoDetect(creatorVisibility = Visibility.NONE, fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE, setterVisibility = Visibility.NONE)
public class QueueInteractionCountAnalyticsWidgetData implements AnalyticsWidgetData {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		QUEUEINTERACTIONCOUNTANALYTICSWIDGETDATA("QueueInteractionCountAnalyticsWidgetData");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.QUEUEINTERACTIONCOUNTANALYTICSWIDGETDATA;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.QUEUEINTERACTIONCOUNTANALYTICSWIDGETDATA;
	...
	private EAnalyticsKpiType kpiType = EAnalyticsKpiType.QUEUE_INTERACTION_COUNT;
	...
	private List<EQueueInteractionGroupBy> groupBy = null;

	public static final String JSON_PROPERTY_FILTERS = "filters";
	@JsonProperty(JSON_PROPERTY_FILTERS)
	private QueueInteractionCountAnalyticsKpiFilterData filters = null;

	public QueueInteractionCountAnalyticsWidgetData $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public QueueInteractionCountAnalyticsWidgetData id(String id) {
		this.id = id;
		return this;
	}
	...
	public QueueInteractionCountAnalyticsWidgetData accountId(String accountId) {
	...
	public QueueInteractionCountAnalyticsWidgetData creationTimestamp(Long creationTimestamp) {
	...
	public QueueInteractionCountAnalyticsWidgetData modificationTimestamp(Long modificationTimestamp) {
	...
	public QueueInteractionCountAnalyticsWidgetData version(Long version) {
	...
	public QueueInteractionCountAnalyticsWidgetData analyticsDashboardId(String analyticsDashboardId) {
	...
	public QueueInteractionCountAnalyticsWidgetData name(String name) {
		this.name = name;
		return this;
	}
	...
	public QueueInteractionCountAnalyticsWidgetData description(String description) {
	...
	public QueueInteractionCountAnalyticsWidgetData kpiType(EAnalyticsKpiType kpiType) {
	...
	public QueueInteractionCountAnalyticsWidgetData row(Integer row) {
		this.row = row;
		return this;
	}
	...
	public QueueInteractionCountAnalyticsWidgetData rowSpan(Integer rowSpan) {
	...
	public QueueInteractionCountAnalyticsWidgetData column(Integer column) {
		this.column = column;
		return this;
	}
	...
	public QueueInteractionCountAnalyticsWidgetData columnSpan(Integer columnSpan) {
	...
	public QueueInteractionCountAnalyticsWidgetData displaySingleValueAggregation(EAnalyticsKpiDisplaySingleValueAggregation displaySingleValueAggregation) {
	...
	public QueueInteractionCountAnalyticsWidgetData displaySingleValuePreviousPeriodComparison(Boolean displaySingleValuePreviousPeriodComparison) {
	...
	public QueueInteractionCountAnalyticsWidgetData displayChart(EAnalyticsKpiDisplayChart displayChart) {
	...
	public QueueInteractionCountAnalyticsWidgetData initialTimeFrameType(EAnalyticsKpiTimeFrameType initialTimeFrameType) {
	...
	public QueueInteractionCountAnalyticsWidgetData initialTimeFrameSpan(EAnalyticsKpiFixedTimeFrameSpan initialTimeFrameSpan) {
	...
	public QueueInteractionCountAnalyticsWidgetData initialTimeFrameLastDays(Integer initialTimeFrameLastDays) {
	...
	public QueueInteractionCountAnalyticsWidgetData granularityType(EAnalyticsKpiGranularityType granularityType) {
	...
	public QueueInteractionCountAnalyticsWidgetData fixedGranularity(EAnalyticsKpiFixedGranularity fixedGranularity) {
	...
	public QueueInteractionCountAnalyticsWidgetData translations(Map<String, AnalyticsWidgetTranslation> translations) {
		this.translations = translations;
		return this;
	}

	public QueueInteractionCountAnalyticsWidgetData putTranslationsItem(String key, AnalyticsWidgetTranslation translationsItem) {
	...
	public QueueInteractionCountAnalyticsWidgetData referenceLines(List<AnalyticsKpiReferenceLine> referenceLines) {
		this.referenceLines = referenceLines;
		return this;
	}

	public QueueInteractionCountAnalyticsWidgetData addReferenceLinesItem(AnalyticsKpiReferenceLine referenceLinesItem) {
	...
	public QueueInteractionCountAnalyticsWidgetData filtersType(EAnalyticsKpiFiltersType filtersType) {
	...
	public QueueInteractionCountAnalyticsWidgetData groupBy(List<EQueueInteractionGroupBy> groupBy) {
		this.groupBy = groupBy;
		return this;
	}

	public QueueInteractionCountAnalyticsWidgetData addGroupByItem(EQueueInteractionGroupBy groupByItem) {
	...
	/**
	 * Specifies how results are grouped for the queue interaction KPI. Only the first value of the list is used.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the queue interaction KPI. Only the first value of the list is used.")
	public List<EQueueInteractionGroupBy> getGroupBy() {
		return groupBy;
	}

	public void setGroupBy(List<EQueueInteractionGroupBy> groupBy) {
		this.groupBy = groupBy;
	}

	public QueueInteractionCountAnalyticsWidgetData filters(QueueInteractionCountAnalyticsKpiFilterData filters) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public QueueInteractionCountAnalyticsKpiFilterData getFilters() {
		return filters;
	}

	public void setFilters(QueueInteractionCountAnalyticsKpiFilterData filters) {
		this.filters = filters;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		QueueInteractionCountAnalyticsWidgetData queueInteractionCountAnalyticsWidgetData = (QueueInteractionCountAnalyticsWidgetData) o;
		return Objects.equals(this.$type, queueInteractionCountAnalyticsWidgetData.$type) &&
				Objects.equals(this.id, queueInteractionCountAnalyticsWidgetData.id) &&
				Objects.equals(this.accountId, queueInteractionCountAnalyticsWidgetData.accountId) &&
				Objects.equals(this.creationTimestamp, queueInteractionCountAnalyticsWidgetData.creationTimestamp) &&
				Objects.equals(this.modificationTimestamp, queueInteractionCountAnalyticsWidgetData.modificationTimestamp) &&
				Objects.equals(this.version, queueInteractionCountAnalyticsWidgetData.version) &&
				Objects.equals(this.analyticsDashboardId, queueInteractionCountAnalyticsWidgetData.analyticsDashboardId) &&
				Objects.equals(this.name, queueInteractionCountAnalyticsWidgetData.name) &&
				Objects.equals(this.description, queueInteractionCountAnalyticsWidgetData.description) &&
				Objects.equals(this.kpiType, queueInteractionCountAnalyticsWidgetData.kpiType) &&
				Objects.equals(this.row, queueInteractionCountAnalyticsWidgetData.row) &&
				Objects.equals(this.rowSpan, queueInteractionCountAnalyticsWidgetData.rowSpan) &&
				Objects.equals(this.column, queueInteractionCountAnalyticsWidgetData.column) &&
				Objects.equals(this.columnSpan, queueInteractionCountAnalyticsWidgetData.columnSpan) &&
				Objects.equals(this.displaySingleValueAggregation, queueInteractionCountAnalyticsWidgetData.displaySingleValueAggregation) &&
				Objects.equals(this.displaySingleValuePreviousPeriodComparison, queueInteractionCountAnalyticsWidgetData.displaySingleValuePreviousPeriodComparison) &&
				Objects.equals(this.displayChart, queueInteractionCountAnalyticsWidgetData.displayChart) &&
				Objects.equals(this.initialTimeFrameType, queueInteractionCountAnalyticsWidgetData.initialTimeFrameType) &&
				Objects.equals(this.initialTimeFrameSpan, queueInteractionCountAnalyticsWidgetData.initialTimeFrameSpan) &&
				Objects.equals(this.initialTimeFrameLastDays, queueInteractionCountAnalyticsWidgetData.initialTimeFrameLastDays) &&
				Objects.equals(this.granularityType, queueInteractionCountAnalyticsWidgetData.granularityType) &&
				Objects.equals(this.fixedGranularity, queueInteractionCountAnalyticsWidgetData.fixedGranularity) &&
				Objects.equals(this.translations, queueInteractionCountAnalyticsWidgetData.translations) &&
				Objects.equals(this.referenceLines, queueInteractionCountAnalyticsWidgetData.referenceLines) &&
				Objects.equals(this.filtersType, queueInteractionCountAnalyticsWidgetData.filtersType) &&
				Objects.equals(this.groupBy, queueInteractionCountAnalyticsWidgetData.groupBy) &&
				Objects.equals(this.filters, queueInteractionCountAnalyticsWidgetData.filters);
	}
	...
	public String toString() {
		...
		sb.append("class QueueInteractionCountAnalyticsWidgetData {\n");
