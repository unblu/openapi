...
@JsonPropertyOrder({
	...
	QuestionAbortedMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	QuestionAbortedMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
	QuestionAbortedMessageData.JSON_PROPERTY_QUESTION_MESSAGE_ID,
	QuestionAbortedMessageData.JSON_PROPERTY_VALUE,
	QuestionAbortedMessageData.JSON_PROPERTY_AVAILABLE_TRANSLATIONS,
...
public class QuestionAbortedMessageData implements MessageData {
	...
	public QuestionAbortedMessageData botThreadId(String botThreadId) {
	...
	public QuestionAbortedMessageData internal(Boolean internal) {
	...
	public QuestionAbortedMessageData replyToMessageId(String replyToMessageId) {
	...
	public QuestionAbortedMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public QuestionAbortedMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public QuestionAbortedMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public QuestionAbortedMessageData availableTranslations(List<ReplyMessageTranslation> availableTranslations) {
		this.availableTranslations = availableTranslations;
		return this;
	}

	public QuestionAbortedMessageData addAvailableTranslationsItem(ReplyMessageTranslation availableTranslationsItem) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, questionAbortedMessageData.$type) &&
				...
				Objects.equals(this.lastEditedByPersonId, questionAbortedMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, questionAbortedMessageData.lastEditedTimestamp) &&
