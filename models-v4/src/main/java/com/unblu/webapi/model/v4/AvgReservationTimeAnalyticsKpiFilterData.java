 ...
 * &lt;li&gt;(recipientAgentIds OR recipientTeamIds OR recipientNamedAreaIds OR recipientAccountId) AND&lt;/li&gt; &lt;li&gt;queueInteractionTypes
...
@JsonPropertyOrder({
	...
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_START_TIMESTAMP,
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_END_TIMESTAMP,
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_CONVERSATION_TEMPLATE_IDS,
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_CONVERSATION_LOCALES,
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_INITIAL_ENGAGEMENT_TYPES,
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_RECIPIENT_AGENT_PERSON_IDS,
	...
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_MIN_RESERVATION_TIME_DURATION,
	AvgReservationTimeAnalyticsKpiFilterData.JSON_PROPERTY_MAX_RESERVATION_TIME_DURATION,
})
@JsonAutoDetect(creatorVisibility = Visibility.NONE, fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE, setterVisibility = Visibility.NONE)
public class AvgReservationTimeAnalyticsKpiFilterData {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		AVGRESERVATIONTIMEANALYTICSKPIFILTERDATA("AvgReservationTimeAnalyticsKpiFilterData");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.AVGRESERVATIONTIMEANALYTICSKPIFILTERDATA;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.AVGRESERVATIONTIMEANALYTICSKPIFILTERDATA;
	...
	public AvgReservationTimeAnalyticsKpiFilterData $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public AvgReservationTimeAnalyticsKpiFilterData startTimestamp(Long startTimestamp) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData endTimestamp(Long endTimestamp) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData conversationTemplateIds(List<String> conversationTemplateIds) {
		this.conversationTemplateIds = conversationTemplateIds;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addConversationTemplateIdsItem(String conversationTemplateIdsItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData conversationLocales(List<String> conversationLocales) {
		this.conversationLocales = conversationLocales;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addConversationLocalesItem(String conversationLocalesItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData initialEngagementTypes(List<EInitialEngagementType> initialEngagementTypes) {
		this.initialEngagementTypes = initialEngagementTypes;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addInitialEngagementTypesItem(EInitialEngagementType initialEngagementTypesItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData recipientAgentPersonIds(List<String> recipientAgentPersonIds) {
		this.recipientAgentPersonIds = recipientAgentPersonIds;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addRecipientAgentPersonIdsItem(String recipientAgentPersonIdsItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData recipientTeamIds(List<String> recipientTeamIds) {
		this.recipientTeamIds = recipientTeamIds;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addRecipientTeamIdsItem(String recipientTeamIdsItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData recipientNamedAreaIds(List<String> recipientNamedAreaIds) {
		this.recipientNamedAreaIds = recipientNamedAreaIds;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addRecipientNamedAreaIdsItem(String recipientNamedAreaIdsItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData recipientAccountId(Boolean recipientAccountId) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData addQueueInteractionTypesItem(EQueueInteractionType queueInteractionTypesItem) {
	...
	/**
	 * A list of queue interaction types used to restrict which reservation outcomes are considered in the KPI calculation. Records matching any of the specified
	 * outcomes are included. Only &#x60;RESERVATION_*&#x60; values are accepted; other values are rejected during validation. If null, all reservation outcomes are
	 * considered. An empty list is not allowed.
	 * 
	 * @return queueInteractionTypes
	 **/
	@ApiModelProperty(value = "A list of queue interaction types used to restrict which reservation outcomes are considered in the KPI calculation. Records matching any of the specified outcomes are included. Only `RESERVATION_*` values are accepted; other values are rejected during validation. If null, all reservation outcomes are considered. An empty list is not allowed.")
	...
	public AvgReservationTimeAnalyticsKpiFilterData assignedAgentPersonIds(List<String> assignedAgentPersonIds) {
		this.assignedAgentPersonIds = assignedAgentPersonIds;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addAssignedAgentPersonIdsItem(String assignedAgentPersonIdsItem) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData assignedAgentTeamIds(List<String> assignedAgentTeamIds) {
		this.assignedAgentTeamIds = assignedAgentTeamIds;
		return this;
	}

	public AvgReservationTimeAnalyticsKpiFilterData addAssignedAgentTeamIdsItem(String assignedAgentTeamIdsItem) {
	...
	/**
	 * A list of assigned agent team IDs used to filter the analytics data included in the KPI calculation. The team is that of the agent who redeemed the
	 * invitation, or the agent the invitation was reserved for. Records matching any of the specified IDs are included. The specified IDs must exist in the Unblu
	 ...
	 **/
	@ApiModelProperty(value = "A list of assigned agent team IDs used to filter the analytics data included in the KPI calculation. The team is that of the agent who redeemed the invitation, or the agent the invitation was reserved for. Records matching any of the specified IDs are included. The specified IDs must exist in the Unblu database and be accessible to the user. Supports the `CURRENT_TEAM` variable. If null, the filter is not applied. An empty list is not allowed. Optional.")
	...
	public AvgReservationTimeAnalyticsKpiFilterData minReservationTimeDuration(Long minReservationTimeDuration) {
	...
	public AvgReservationTimeAnalyticsKpiFilterData maxReservationTimeDuration(Long maxReservationTimeDuration) {
	...
	public boolean equals(java.lang.Object o) {
		...
		AvgReservationTimeAnalyticsKpiFilterData avgReservationTimeAnalyticsKpiFilterData = (AvgReservationTimeAnalyticsKpiFilterData) o;
		return Objects.equals(this.$type, avgReservationTimeAnalyticsKpiFilterData.$type) &&
				Objects.equals(this.startTimestamp, avgReservationTimeAnalyticsKpiFilterData.startTimestamp) &&
				Objects.equals(this.endTimestamp, avgReservationTimeAnalyticsKpiFilterData.endTimestamp) &&
				Objects.equals(this.conversationTemplateIds, avgReservationTimeAnalyticsKpiFilterData.conversationTemplateIds) &&
				Objects.equals(this.conversationLocales, avgReservationTimeAnalyticsKpiFilterData.conversationLocales) &&
				Objects.equals(this.initialEngagementTypes, avgReservationTimeAnalyticsKpiFilterData.initialEngagementTypes) &&
				Objects.equals(this.recipientAgentPersonIds, avgReservationTimeAnalyticsKpiFilterData.recipientAgentPersonIds) &&
				...
				Objects.equals(this.minReservationTimeDuration, avgReservationTimeAnalyticsKpiFilterData.minReservationTimeDuration) &&
				Objects.equals(this.maxReservationTimeDuration, avgReservationTimeAnalyticsKpiFilterData.maxReservationTimeDuration);
	}
	...
	public String toString() {
		...
		sb.append("class AvgReservationTimeAnalyticsKpiFilterData {\n");
