...
/**
 * Information about an external participant in a conversation (with historical information).
 */
@ApiModel(description = "Information about an external participant in a conversation (with historical information).")
