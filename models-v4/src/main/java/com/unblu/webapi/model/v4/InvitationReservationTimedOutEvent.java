...
/**
 * Invitation reservation timed out event
 */
@ApiModel(description = "Invitation reservation timed out event")

@JsonPropertyOrder({
	InvitationReservationTimedOutEvent.JSON_PROPERTY_$_TYPE,
	InvitationReservationTimedOutEvent.JSON_PROPERTY_TIMESTAMP,
	InvitationReservationTimedOutEvent.JSON_PROPERTY_EVENT_TYPE,
	InvitationReservationTimedOutEvent.JSON_PROPERTY_ACCOUNT_ID,
	InvitationReservationTimedOutEvent.JSON_PROPERTY_INVITATION_ID,
	InvitationReservationTimedOutEvent.JSON_PROPERTY_CONVERSATION,
	InvitationReservationTimedOutEvent.JSON_PROPERTY_TOKEN,
...
public class InvitationReservationTimedOutEvent {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		INVITATIONRESERVATIONTIMEDOUTEVENT("InvitationReservationTimedOutEvent");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.INVITATIONRESERVATIONTIMEDOUTEVENT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.INVITATIONRESERVATIONTIMEDOUTEVENT;
	...
	public InvitationReservationTimedOutEvent $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public InvitationReservationTimedOutEvent timestamp(Long timestamp) {
	...
	public InvitationReservationTimedOutEvent eventType(String eventType) {
	...
	public InvitationReservationTimedOutEvent accountId(String accountId) {
	...
	public InvitationReservationTimedOutEvent invitationId(String invitationId) {
	...
	public InvitationReservationTimedOutEvent conversation(ConversationData conversation) {
	...
	public InvitationReservationTimedOutEvent token(String token) {
		this.token = token;
		return this;
	}
	...
	public InvitationReservationTimedOutEvent creationTimestamp(Long creationTimestamp) {
	...
	public InvitationReservationTimedOutEvent creatorType(EInvitationCreatorType creatorType) {
	...
	public InvitationReservationTimedOutEvent creatorPerson(PersonData creatorPerson) {
	...
	public InvitationReservationTimedOutEvent target(ConversationRecipientData target) {
		this.target = target;
		return this;
	}
	...
	public InvitationReservationTimedOutEvent reservationPerson(PersonData reservationPerson) {
	...
	public boolean equals(java.lang.Object o) {
		...
		InvitationReservationTimedOutEvent invitationReservationTimedOutEvent = (InvitationReservationTimedOutEvent) o;
		return Objects.equals(this.$type, invitationReservationTimedOutEvent.$type) &&
				Objects.equals(this.timestamp, invitationReservationTimedOutEvent.timestamp) &&
				Objects.equals(this.eventType, invitationReservationTimedOutEvent.eventType) &&
				Objects.equals(this.accountId, invitationReservationTimedOutEvent.accountId) &&
				Objects.equals(this.invitationId, invitationReservationTimedOutEvent.invitationId) &&
				Objects.equals(this.conversation, invitationReservationTimedOutEvent.conversation) &&
				Objects.equals(this.token, invitationReservationTimedOutEvent.token) &&
	...
	public String toString() {
		...
		sb.append("class InvitationReservationTimedOutEvent {\n");
