...
public class ConversationFileData {
	...
	public ConversationFileData downloadLinks(List<DownloadLink> downloadLinks) {
		this.downloadLinks = downloadLinks;
		return this;
	}

	public ConversationFileData addDownloadLinksItem(DownloadLink downloadLinksItem) {
