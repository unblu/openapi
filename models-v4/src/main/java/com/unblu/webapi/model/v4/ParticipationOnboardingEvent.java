...
/**
 * An event triggered every time a participant starts the onboarding process &lt;p&gt; Supported filter keys: &lt;ul&gt;
 ...
 */
@ApiModel(description = "An event triggered every time a participant starts the onboarding process <p> Supported filter keys: <ul> <li>`ETypedEventFilterKey.CONVERSATION_ID`: conversation ID</li> <li>`ETypedEventFilterKey.PARTICIPANT_PERSON_ID`: participant person ID</li> </ul>")
