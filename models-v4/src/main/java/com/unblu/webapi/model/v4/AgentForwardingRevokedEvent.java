...
/**
 * Agent forwarding revoked event
 */
@ApiModel(description = "Agent forwarding revoked event")

@JsonPropertyOrder({
	AgentForwardingRevokedEvent.JSON_PROPERTY_$_TYPE,
	AgentForwardingRevokedEvent.JSON_PROPERTY_TIMESTAMP,
	AgentForwardingRevokedEvent.JSON_PROPERTY_EVENT_TYPE,
	AgentForwardingRevokedEvent.JSON_PROPERTY_ACCOUNT_ID,
	AgentForwardingRevokedEvent.JSON_PROPERTY_INVITATION_ID,
	AgentForwardingRevokedEvent.JSON_PROPERTY_CONVERSATION,
	AgentForwardingRevokedEvent.JSON_PROPERTY_TOKEN,
	AgentForwardingRevokedEvent.JSON_PROPERTY_CREATION_TIMESTAMP,
	AgentForwardingRevokedEvent.JSON_PROPERTY_CREATOR_TYPE,
	AgentForwardingRevokedEvent.JSON_PROPERTY_CREATOR_PERSON,
	AgentForwardingRevokedEvent.JSON_PROPERTY_RESERVATION,
...
public class AgentForwardingRevokedEvent {
	...
	public enum TypeEnum {
		AGENTFORWARDINGREVOKEDEVENT("AgentForwardingRevokedEvent");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.AGENTFORWARDINGREVOKEDEVENT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.AGENTFORWARDINGREVOKEDEVENT;
	...
	public AgentForwardingRevokedEvent timestamp(Long timestamp) {
	...
	public AgentForwardingRevokedEvent eventType(String eventType) {
	...
	public AgentForwardingRevokedEvent accountId(String accountId) {
	...
	public AgentForwardingRevokedEvent invitationId(String invitationId) {
	...
	public AgentForwardingRevokedEvent conversation(ConversationData conversation) {
	...
	public AgentForwardingRevokedEvent token(String token) {
		this.token = token;
		return this;
	}
	...
	public AgentForwardingRevokedEvent creationTimestamp(Long creationTimestamp) {
	...
	public AgentForwardingRevokedEvent creatorType(EInvitationCreatorType creatorType) {
	...
	public AgentForwardingRevokedEvent creatorPerson(PersonData creatorPerson) {
	...
	public AgentForwardingRevokedEvent reservation(InvitationReservationData reservation) {
	...
	public AgentForwardingRevokedEvent contextPersonInfo(ContextPersonInfo contextPersonInfo) {
	...
	public AgentForwardingRevokedEvent target(AgentTargetData target) {
		this.target = target;
		return this;
	}
	...
	public AgentForwardingRevokedEvent comment(String comment) {
	...
	public boolean equals(java.lang.Object o) {
		...
		AgentForwardingRevokedEvent agentForwardingRevokedEvent = (AgentForwardingRevokedEvent) o;
		return Objects.equals(this.$type, agentForwardingRevokedEvent.$type) &&
				Objects.equals(this.timestamp, agentForwardingRevokedEvent.timestamp) &&
				Objects.equals(this.eventType, agentForwardingRevokedEvent.eventType) &&
				Objects.equals(this.accountId, agentForwardingRevokedEvent.accountId) &&
				Objects.equals(this.invitationId, agentForwardingRevokedEvent.invitationId) &&
				Objects.equals(this.conversation, agentForwardingRevokedEvent.conversation) &&
				Objects.equals(this.token, agentForwardingRevokedEvent.token) &&
				Objects.equals(this.creationTimestamp, agentForwardingRevokedEvent.creationTimestamp) &&
				Objects.equals(this.creatorType, agentForwardingRevokedEvent.creatorType) &&
				Objects.equals(this.creatorPerson, agentForwardingRevokedEvent.creatorPerson) &&
				Objects.equals(this.reservation, agentForwardingRevokedEvent.reservation) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, timestamp, eventType, accountId, invitationId, conversation, token, creationTimestamp, creatorType, creatorPerson, reservation, contextPersonInfo, target, comment, invitationResponseState);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AgentForwardingRevokedEvent {\n");
