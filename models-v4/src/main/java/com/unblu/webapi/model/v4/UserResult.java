...
/**
 * Container to return list of users
 */
@ApiModel(description = "Container to return list of users")

@JsonPropertyOrder({
	UserResult.JSON_PROPERTY_$_TYPE,
	UserResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	UserResult.JSON_PROPERTY_NEXT_OFFSET,
	UserResult.JSON_PROPERTY_ITEMS,
})
...
public class UserResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.USERRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.USERRESULT;
	...
	public UserResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public UserResult hasMoreItems(Boolean hasMoreItems) {
	...
	public UserResult nextOffset(Integer nextOffset) {
	...
	public UserResult items(List<User> items) {
		this.items = items;
		return this;
	}

	public UserResult addItemsItem(User itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, userResult.$type) &&
				Objects.equals(this.hasMoreItems, userResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, userResult.nextOffset) &&
				Objects.equals(this.items, userResult.items);
	}
