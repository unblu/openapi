...
/**
 * Container to return list of domains
 */
@ApiModel(description = "Container to return list of domains")

@JsonPropertyOrder({
	DomainResult.JSON_PROPERTY_$_TYPE,
	DomainResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	DomainResult.JSON_PROPERTY_NEXT_OFFSET,
	DomainResult.JSON_PROPERTY_ITEMS,
})
...
public class DomainResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.DOMAINRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.DOMAINRESULT;
	...
	public DomainResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public DomainResult hasMoreItems(Boolean hasMoreItems) {
	...
	public DomainResult nextOffset(Integer nextOffset) {
	...
	public DomainResult items(List<Domain> items) {
		this.items = items;
		return this;
	}

	public DomainResult addItemsItem(Domain itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		DomainResult domainResult = (DomainResult) o;
		return Objects.equals(this.$type, domainResult.$type) &&
				Objects.equals(this.hasMoreItems, domainResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, domainResult.nextOffset) &&
				Objects.equals(this.items, domainResult.items);
	}
