...
public class RatingQuestionMessageData implements MessageData {
	...
	public RatingQuestionMessageData replyToMessageId(String replyToMessageId) {
	...
	public RatingQuestionMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public RatingQuestionMessageData conversationLocale(String conversationLocale) {
