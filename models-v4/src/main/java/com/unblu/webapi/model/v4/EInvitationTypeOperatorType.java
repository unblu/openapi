...
/**
 * Gets or Sets EInvitationTypeOperatorType
 */
public enum EInvitationTypeOperatorType {
	...
	EInvitationTypeOperatorType(String value) {
		this.value = value;
	}
	...
	@JsonCreator
	public static EInvitationTypeOperatorType fromValue(String value) {
		for (EInvitationTypeOperatorType b : EInvitationTypeOperatorType.values()) {
