...
/**
 * Data model representing the conversations ended analytics widget
 */
@ApiModel(description = "Data model representing the conversations ended analytics widget")

@JsonPropertyOrder({
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_$_TYPE,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_ID,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_ACCOUNT_ID,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_CREATION_TIMESTAMP,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_MODIFICATION_TIMESTAMP,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_VERSION,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_ANALYTICS_DASHBOARD_ID,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_NAME,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_DESCRIPTION,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_KPI_TYPE,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_ROW,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_ROW_SPAN,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_COLUMN_SPAN,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_AGGREGATION,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_SINGLE_VALUE_PREVIOUS_PERIOD_COMPARISON,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_DISPLAY_CHART,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_TYPE,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_SPAN,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_INITIAL_TIME_FRAME_LAST_DAYS,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_GRANULARITY_TYPE,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_FIXED_GRANULARITY,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_TRANSLATIONS,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_REFERENCE_LINES,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS_TYPE,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_GROUP_BY,
	ConversationsEndedCountAnalyticsWidgetData.JSON_PROPERTY_FILTERS,
})
@JsonAutoDetect(creatorVisibility = Visibility.NONE, fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE, setterVisibility = Visibility.NONE)
public class ConversationsEndedCountAnalyticsWidgetData implements AnalyticsWidgetData {
	/**
	 * Gets or Sets $type
	 */
	public enum TypeEnum {
		CONVERSATIONSENDEDCOUNTANALYTICSWIDGETDATA("ConversationsEndedCountAnalyticsWidgetData");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.CONVERSATIONSENDEDCOUNTANALYTICSWIDGETDATA;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.CONVERSATIONSENDEDCOUNTANALYTICSWIDGETDATA;
	...
	private EAnalyticsKpiType kpiType = EAnalyticsKpiType.CONVERSATIONS_ENDED_COUNT;
	...
	private List<EConversationsEndedCountGroupBy> groupBy = null;

	public static final String JSON_PROPERTY_FILTERS = "filters";
	@JsonProperty(JSON_PROPERTY_FILTERS)
	private ConversationsEndedCountAnalyticsKpiFilterData filters = null;

	public ConversationsEndedCountAnalyticsWidgetData $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public ConversationsEndedCountAnalyticsWidgetData id(String id) {
		this.id = id;
		return this;
	}
	...
	public ConversationsEndedCountAnalyticsWidgetData accountId(String accountId) {
	...
	public ConversationsEndedCountAnalyticsWidgetData creationTimestamp(Long creationTimestamp) {
	...
	public ConversationsEndedCountAnalyticsWidgetData modificationTimestamp(Long modificationTimestamp) {
	...
	public ConversationsEndedCountAnalyticsWidgetData version(Long version) {
	...
	public ConversationsEndedCountAnalyticsWidgetData analyticsDashboardId(String analyticsDashboardId) {
	...
	public ConversationsEndedCountAnalyticsWidgetData name(String name) {
		this.name = name;
		return this;
	}
	...
	public ConversationsEndedCountAnalyticsWidgetData description(String description) {
	...
	public ConversationsEndedCountAnalyticsWidgetData kpiType(EAnalyticsKpiType kpiType) {
	...
	public ConversationsEndedCountAnalyticsWidgetData row(Integer row) {
		this.row = row;
		return this;
	}
	...
	public ConversationsEndedCountAnalyticsWidgetData rowSpan(Integer rowSpan) {
	...
	public ConversationsEndedCountAnalyticsWidgetData column(Integer column) {
		this.column = column;
		return this;
	}
	...
	public ConversationsEndedCountAnalyticsWidgetData columnSpan(Integer columnSpan) {
	...
	public ConversationsEndedCountAnalyticsWidgetData displaySingleValueAggregation(EAnalyticsKpiDisplaySingleValueAggregation displaySingleValueAggregation) {
	...
	public ConversationsEndedCountAnalyticsWidgetData displaySingleValuePreviousPeriodComparison(Boolean displaySingleValuePreviousPeriodComparison) {
	...
	public ConversationsEndedCountAnalyticsWidgetData displayChart(EAnalyticsKpiDisplayChart displayChart) {
	...
	public ConversationsEndedCountAnalyticsWidgetData initialTimeFrameType(EAnalyticsKpiTimeFrameType initialTimeFrameType) {
	...
	public ConversationsEndedCountAnalyticsWidgetData initialTimeFrameSpan(EAnalyticsKpiFixedTimeFrameSpan initialTimeFrameSpan) {
	...
	public ConversationsEndedCountAnalyticsWidgetData initialTimeFrameLastDays(Integer initialTimeFrameLastDays) {
	...
	public ConversationsEndedCountAnalyticsWidgetData granularityType(EAnalyticsKpiGranularityType granularityType) {
	...
	public ConversationsEndedCountAnalyticsWidgetData fixedGranularity(EAnalyticsKpiFixedGranularity fixedGranularity) {
	...
	public ConversationsEndedCountAnalyticsWidgetData translations(Map<String, AnalyticsWidgetTranslation> translations) {
		this.translations = translations;
		return this;
	}

	public ConversationsEndedCountAnalyticsWidgetData putTranslationsItem(String key, AnalyticsWidgetTranslation translationsItem) {
	...
	public ConversationsEndedCountAnalyticsWidgetData referenceLines(List<AnalyticsKpiReferenceLine> referenceLines) {
		this.referenceLines = referenceLines;
		return this;
	}

	public ConversationsEndedCountAnalyticsWidgetData addReferenceLinesItem(AnalyticsKpiReferenceLine referenceLinesItem) {
	...
	public ConversationsEndedCountAnalyticsWidgetData filtersType(EAnalyticsKpiFiltersType filtersType) {
	...
	public ConversationsEndedCountAnalyticsWidgetData groupBy(List<EConversationsEndedCountGroupBy> groupBy) {
		this.groupBy = groupBy;
		return this;
	}

	public ConversationsEndedCountAnalyticsWidgetData addGroupByItem(EConversationsEndedCountGroupBy groupByItem) {
	...
	/**
	 * Specifies how results are grouped for the conversations ended KPI. Only the first value of the list is used.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the conversations ended KPI. Only the first value of the list is used.")
	public List<EConversationsEndedCountGroupBy> getGroupBy() {
		return groupBy;
	}

	public void setGroupBy(List<EConversationsEndedCountGroupBy> groupBy) {
		this.groupBy = groupBy;
	}

	public ConversationsEndedCountAnalyticsWidgetData filters(ConversationsEndedCountAnalyticsKpiFilterData filters) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public ConversationsEndedCountAnalyticsKpiFilterData getFilters() {
		return filters;
	}

	public void setFilters(ConversationsEndedCountAnalyticsKpiFilterData filters) {
		this.filters = filters;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ConversationsEndedCountAnalyticsWidgetData conversationsEndedCountAnalyticsWidgetData = (ConversationsEndedCountAnalyticsWidgetData) o;
		return Objects.equals(this.$type, conversationsEndedCountAnalyticsWidgetData.$type) &&
				Objects.equals(this.id, conversationsEndedCountAnalyticsWidgetData.id) &&
				Objects.equals(this.accountId, conversationsEndedCountAnalyticsWidgetData.accountId) &&
				Objects.equals(this.creationTimestamp, conversationsEndedCountAnalyticsWidgetData.creationTimestamp) &&
				Objects.equals(this.modificationTimestamp, conversationsEndedCountAnalyticsWidgetData.modificationTimestamp) &&
				Objects.equals(this.version, conversationsEndedCountAnalyticsWidgetData.version) &&
				Objects.equals(this.analyticsDashboardId, conversationsEndedCountAnalyticsWidgetData.analyticsDashboardId) &&
				Objects.equals(this.name, conversationsEndedCountAnalyticsWidgetData.name) &&
				Objects.equals(this.description, conversationsEndedCountAnalyticsWidgetData.description) &&
				Objects.equals(this.kpiType, conversationsEndedCountAnalyticsWidgetData.kpiType) &&
				Objects.equals(this.row, conversationsEndedCountAnalyticsWidgetData.row) &&
				Objects.equals(this.rowSpan, conversationsEndedCountAnalyticsWidgetData.rowSpan) &&
				Objects.equals(this.column, conversationsEndedCountAnalyticsWidgetData.column) &&
				Objects.equals(this.columnSpan, conversationsEndedCountAnalyticsWidgetData.columnSpan) &&
				Objects.equals(this.displaySingleValueAggregation, conversationsEndedCountAnalyticsWidgetData.displaySingleValueAggregation) &&
				Objects.equals(this.displaySingleValuePreviousPeriodComparison, conversationsEndedCountAnalyticsWidgetData.displaySingleValuePreviousPeriodComparison) &&
				Objects.equals(this.displayChart, conversationsEndedCountAnalyticsWidgetData.displayChart) &&
				Objects.equals(this.initialTimeFrameType, conversationsEndedCountAnalyticsWidgetData.initialTimeFrameType) &&
				Objects.equals(this.initialTimeFrameSpan, conversationsEndedCountAnalyticsWidgetData.initialTimeFrameSpan) &&
				Objects.equals(this.initialTimeFrameLastDays, conversationsEndedCountAnalyticsWidgetData.initialTimeFrameLastDays) &&
				Objects.equals(this.granularityType, conversationsEndedCountAnalyticsWidgetData.granularityType) &&
				Objects.equals(this.fixedGranularity, conversationsEndedCountAnalyticsWidgetData.fixedGranularity) &&
				Objects.equals(this.translations, conversationsEndedCountAnalyticsWidgetData.translations) &&
				Objects.equals(this.referenceLines, conversationsEndedCountAnalyticsWidgetData.referenceLines) &&
				Objects.equals(this.filtersType, conversationsEndedCountAnalyticsWidgetData.filtersType) &&
				Objects.equals(this.groupBy, conversationsEndedCountAnalyticsWidgetData.groupBy) &&
				Objects.equals(this.filters, conversationsEndedCountAnalyticsWidgetData.filters);
	}
	...
	public String toString() {
		...
		sb.append("class ConversationsEndedCountAnalyticsWidgetData {\n");
