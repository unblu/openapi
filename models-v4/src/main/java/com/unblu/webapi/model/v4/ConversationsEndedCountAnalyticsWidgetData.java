...
public class ConversationsEndedCountAnalyticsWidgetData implements AnalyticsWidgetData {
	...
	/**
	 * Specifies how results are grouped for the conversations ended KPI.
	 * 
	 * @return groupBy
	 **/
	@ApiModelProperty(value = "Specifies how results are grouped for the conversations ended KPI.")
