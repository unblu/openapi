...
@JsonPropertyOrder({
	...
	TextQuestionMessageData.JSON_PROPERTY_LAST_EDITED_BY_PERSON_ID,
	TextQuestionMessageData.JSON_PROPERTY_LAST_EDITED_TIMESTAMP,
...
public class TextQuestionMessageData implements MessageData {
	...
	public TextQuestionMessageData externalMessageId(String externalMessageId) {
	...
	public TextQuestionMessageData replyToExternalMessageId(String replyToExternalMessageId) {
	...
	public TextQuestionMessageData locale(String locale) {
		this.locale = locale;
		return this;
	}
	...
	public TextQuestionMessageData lastEditedByPersonId(String lastEditedByPersonId) {
	...
	public TextQuestionMessageData lastEditedTimestamp(Long lastEditedTimestamp) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, textQuestionMessageData.$type) &&
				...
				Objects.equals(this.lastEditedByPersonId, textQuestionMessageData.lastEditedByPersonId) &&
				Objects.equals(this.lastEditedTimestamp, textQuestionMessageData.lastEditedTimestamp) &&
