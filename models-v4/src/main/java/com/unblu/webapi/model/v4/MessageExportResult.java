...
@JsonPropertyOrder({
	MessageExportResult.JSON_PROPERTY_$_TYPE,
	MessageExportResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	MessageExportResult.JSON_PROPERTY_NEXT_OFFSET,
	MessageExportResult.JSON_PROPERTY_ITEMS,
})
...
public class MessageExportResult {
	...
	public enum TypeEnum {
		MESSAGEEXPORTRESULT("MessageExportResult");
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.MESSAGEEXPORTRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.MESSAGEEXPORTRESULT;
	...
	public MessageExportResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public MessageExportResult hasMoreItems(Boolean hasMoreItems) {
	...
	public MessageExportResult nextOffset(Integer nextOffset) {
	...
	public MessageExportResult items(List<ConversationHistoryMessageData> items) {
		this.items = items;
		return this;
	}

	public MessageExportResult addItemsItem(ConversationHistoryMessageData itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		MessageExportResult messageExportResult = (MessageExportResult) o;
		return Objects.equals(this.$type, messageExportResult.$type) &&
				Objects.equals(this.hasMoreItems, messageExportResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, messageExportResult.nextOffset) &&
				Objects.equals(this.items, messageExportResult.items);
	}
	...
	public String toString() {
		...
		sb.append("class MessageExportResult {\n");
