:module-name: Models v4
:maven-artifact-id: models-v4
...
The model library can be used with different clients such as the git-link:jersey3-client-v4/[Jersey 3.x.x client v4]
