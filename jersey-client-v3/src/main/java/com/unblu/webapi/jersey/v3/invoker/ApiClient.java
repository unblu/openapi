...
import com.unblu.webapi.jersey.v3.invoker.auth.ApiKeyAuth;
import com.unblu.webapi.jersey.v3.invoker.auth.Authentication;
import com.unblu.webapi.jersey.v3.invoker.auth.HttpBasicAuth;
import com.unblu.webapi.jersey.v3.invoker.auth.HttpBearerAuth;

public class ApiClient {
	protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
	protected String basePath = "https://unblu.cloud/app/rest/v3";
	...
	/**
	 * The path of temporary folder used to store downloaded files from endpoints with file response. The default value is <code>null</code>, i.e. using the
	...
	/**
	 * Set the connect timeout (in milliseconds). A value of 0 means no timeout, otherwise values must be between 1 and {@link Integer#MAX_VALUE}.
	 * 
	...
	/**
	 * Set the read timeout (in milliseconds). A value of 0 means no timeout, otherwise values must be between 1 and {@link Integer#MAX_VALUE}.
	 * 
