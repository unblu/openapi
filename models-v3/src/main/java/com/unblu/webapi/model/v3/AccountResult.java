...
/**
 * Container to return list of accounts
 */
@ApiModel(description = "Container to return list of accounts")

@JsonPropertyOrder({
	AccountResult.JSON_PROPERTY_$_TYPE,
	AccountResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	AccountResult.JSON_PROPERTY_NEXT_OFFSET,
	AccountResult.JSON_PROPERTY_ITEMS,
})
...
public class AccountResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.ACCOUNTRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.ACCOUNTRESULT;
	...
	public AccountResult hasMoreItems(Boolean hasMoreItems) {
	...
	public AccountResult nextOffset(Integer nextOffset) {
	...
	public AccountResult items(List<Account> items) {
		this.items = items;
		return this;
	}

	public AccountResult addItemsItem(Account itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, accountResult.$type) &&
				Objects.equals(this.hasMoreItems, accountResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, accountResult.nextOffset) &&
				Objects.equals(this.items, accountResult.items);
	}
