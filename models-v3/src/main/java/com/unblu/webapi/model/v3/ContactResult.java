...
/**
 * Container to return list of contacts
 */
@ApiModel(description = "Container to return list of contacts")

@JsonPropertyOrder({
	ContactResult.JSON_PROPERTY_$_TYPE,
	ContactResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	ContactResult.JSON_PROPERTY_NEXT_OFFSET,
	ContactResult.JSON_PROPERTY_ITEMS,
})
...
public class ContactResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.CONTACTRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.CONTACTRESULT;
	...
	public ContactResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public ContactResult hasMoreItems(Boolean hasMoreItems) {
	...
	public ContactResult nextOffset(Integer nextOffset) {
	...
	public ContactResult items(List<Contact> items) {
		this.items = items;
		return this;
	}

	public ContactResult addItemsItem(Contact itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, contactResult.$type) &&
				Objects.equals(this.hasMoreItems, contactResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, contactResult.nextOffset) &&
