...
/**
 * Gets or Sets EPersonTypeOperatorType
 */
public enum EPersonTypeOperatorType {
	...
	EPersonTypeOperatorType(String value) {
		this.value = value;
	}
	...
	@JsonCreator
	public static EPersonTypeOperatorType fromValue(String value) {
		for (EPersonTypeOperatorType b : EPersonTypeOperatorType.values()) {
