...
@JsonPropertyOrder({
	...
	PersonPresenceData.JSON_PROPERTY_TOUCH_TIMESTAMP,
...
public class PersonPresenceData {
	...
	public static final String JSON_PROPERTY_TOUCH_TIMESTAMP = "touchTimestamp";
	@JsonProperty(JSON_PROPERTY_TOUCH_TIMESTAMP)
	...
	public PersonPresenceData touchTimestamp(Long touchTimestamp) {
	 ...
	 **/
	@ApiModelProperty(value = "Deprecated, will be removed in v4")
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, personPresenceData.$type) &&
				...
				Objects.equals(this.touchTimestamp, personPresenceData.touchTimestamp) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, id, creationTimestamp, modificationTimestamp, accountId, joinedTimestamp, leftTimestamp, personId, deviceInfo, touchTimestamp, impersonationType, impersonatedFromUserId, impersonatedFromAccountId, additionalInfo, authInfo, propagated);
	}
	...
	public String toString() {
		...
		sb.append("    touchTimestamp: ").append(toIndentedString(touchTimestamp)).append("\n");
