 ...
 */
@ApiModel(description = "Event emitted when a dialog between a person and a bot starts. <br> After this event has been received, messages may be sent in this dialog using the passed dialogToken <p> This event will only be delivered to the dialog bots that accepted dialog offer for this dialog beforehand.")
