...
/**
 * Container to return list of addresss
 */
@ApiModel(description = "Container to return list of addresss")

@JsonPropertyOrder({
	AddressResult.JSON_PROPERTY_$_TYPE,
	AddressResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	AddressResult.JSON_PROPERTY_NEXT_OFFSET,
	AddressResult.JSON_PROPERTY_ITEMS,
})
...
public class AddressResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.ADDRESSRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.ADDRESSRESULT;
	...
	public AddressResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public AddressResult hasMoreItems(Boolean hasMoreItems) {
	...
	public AddressResult nextOffset(Integer nextOffset) {
	...
	public AddressResult items(List<Address> items) {
		this.items = items;
		return this;
	}

	public AddressResult addItemsItem(Address itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		AddressResult addressResult = (AddressResult) o;
		return Objects.equals(this.$type, addressResult.$type) &&
				Objects.equals(this.hasMoreItems, addressResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, addressResult.nextOffset) &&
				Objects.equals(this.items, addressResult.items);
	}
