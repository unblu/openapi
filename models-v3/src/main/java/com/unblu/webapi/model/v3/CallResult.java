...
/**
 * Container to return list of call log(s)
 */
@ApiModel(description = "Container to return list of call log(s)")

@JsonPropertyOrder({
	CallResult.JSON_PROPERTY_$_TYPE,
	CallResult.JSON_PROPERTY_HAS_MORE_ITEMS,
	CallResult.JSON_PROPERTY_NEXT_OFFSET,
	CallResult.JSON_PROPERTY_ITEMS,
})
...
public class CallResult {
	...
	public enum TypeEnum {
		...
		public static TypeEnum fromValue(String value) {
			...
			return TypeEnum.CALLRESULT;
		}
	}

	public static final String JSON_PROPERTY_$_TYPE = "$_type";
	@JsonProperty(JSON_PROPERTY_$_TYPE)
	private TypeEnum $type = TypeEnum.CALLRESULT;
	...
	private List<Call> items = null;

	public CallResult $type(TypeEnum $type) {
		this.$type = $type;
		return this;
	}
	...
	public CallResult hasMoreItems(Boolean hasMoreItems) {
	...
	public CallResult nextOffset(Integer nextOffset) {
	...
	public CallResult items(List<Call> items) {
		this.items = items;
		return this;
	}

	public CallResult addItemsItem(Call itemsItem) {
		if (this.items == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, callResult.$type) &&
				Objects.equals(this.hasMoreItems, callResult.hasMoreItems) &&
				Objects.equals(this.nextOffset, callResult.nextOffset) &&
				Objects.equals(this.items, callResult.items);
	}
