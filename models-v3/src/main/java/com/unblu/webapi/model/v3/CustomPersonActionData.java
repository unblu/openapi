...
public class CustomPersonActionData implements CustomActionData {
	...
	public CustomPersonActionData invokableFromFrontends(List<EFrontend> invokableFromFrontends) {
	...
	public CustomPersonActionData invokableForConversationStates(List<EConversationState> invokableForConversationStates) {
	...
	public CustomPersonActionData invokableForParticipationStates(List<EConversationParticipationState> invokableForParticipationStates) {
	...
	public CustomPersonActionData invokableBy(List<EConversationImpactingParticipationType> invokableBy) {
