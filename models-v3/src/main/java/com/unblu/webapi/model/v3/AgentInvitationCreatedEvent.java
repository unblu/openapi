...
public class AgentInvitationCreatedEvent {
	...
	/**
	 * List of links that can be used to accept the agent invitation event with the token.&lt;br&gt; Only one link can be used.
	 * 
	 * @return links
	 **/
	@ApiModelProperty(value = "List of links that can be used to accept the agent invitation event with the token.<br> Only one link can be used.")
