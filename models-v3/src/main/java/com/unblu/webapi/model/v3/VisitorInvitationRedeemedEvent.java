...
@JsonPropertyOrder({
	...
	VisitorInvitationRedeemedEvent.JSON_PROPERTY_CONVERSATION_ID,
	VisitorInvitationRedeemedEvent.JSON_PROPERTY_CONVERSATION,
	VisitorInvitationRedeemedEvent.JSON_PROPERTY_TOKEN,
	VisitorInvitationRedeemedEvent.JSON_PROPERTY_DATE_CREATED,
...
public class VisitorInvitationRedeemedEvent {
	...
	public VisitorInvitationRedeemedEvent conversationId(String conversationId) {
	...
	public VisitorInvitationRedeemedEvent dateCreated(Long dateCreated) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.$type, visitorInvitationRedeemedEvent.$type) &&
				...
				Objects.equals(this.conversationId, visitorInvitationRedeemedEvent.conversationId) &&
				...
				Objects.equals(this.dateCreated, visitorInvitationRedeemedEvent.dateCreated) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, timestamp, eventType, accountId, invitationId, conversationId, conversation, token, dateCreated, creatorType, creatorPerson, email, nickname, expirationTimestamp, redeemingPerson);
	}
