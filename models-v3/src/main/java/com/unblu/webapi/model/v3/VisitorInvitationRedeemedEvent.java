...
public class VisitorInvitationRedeemedEvent {
	...
	@Override
	public int hashCode() {
		return Objects.hash($type, timestamp, eventType, accountId, invitationId, conversationId, token, dateCreated, creatorType, creatorPerson, email, nickname, expirationTimestamp, redeemingPerson);
	}
